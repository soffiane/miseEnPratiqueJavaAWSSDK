...
// snippet-sourcedescription:[others.CreateBucketWithACL.java demonstrates how to create a bucket with a canned ACL and how to modify a bucket's ACL grants.]
// snippet-service:[s3]
