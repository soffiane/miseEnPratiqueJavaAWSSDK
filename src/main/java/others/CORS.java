...
// snippet-sourcedescription:[others.CORS.java demonstrates how to set, get, and delete S3 bucket cross-origin resource sharing configurations.]
// snippet-service:[s3]
...
public class CORS {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Add the rules to a new others.CORS configuration.
        ...
        try {
            ...
            System.out.println("Removed others.CORS configuration.");
