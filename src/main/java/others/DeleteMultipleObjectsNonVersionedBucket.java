...
// snippet-sourcedescription:[others.DeleteMultipleObjectsNonVersionedBucket.java demonstrates how to delete multiple S3 objects from a non-versioned bucket.]
// snippet-service:[s3]
