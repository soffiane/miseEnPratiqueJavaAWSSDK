...
// snippet-sourcedescription:[others.HighLevelTrackMultipartUpload.java demonstrates how to upload a file to S3 and monitor the upload using the TransferManager class.]
// snippet-service:[s3]
