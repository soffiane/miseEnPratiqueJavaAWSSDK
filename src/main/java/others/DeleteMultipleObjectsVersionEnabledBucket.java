...
// snippet-sourcedescription:[others.DeleteMultipleObjectsVersionEnabledBucket.java demonstrates how to delete S3 object versions and remove delete markers from objects in versioned S3 buckets.]
// snippet-service:[s3]
