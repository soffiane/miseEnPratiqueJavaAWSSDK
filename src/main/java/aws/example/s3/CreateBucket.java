//snippet-sourcedescription:[others.CreateBucket.java demonstrates how to create a new S3 bucket.]
...
public class CreateBucket {
    ...
    public static void main(String[] args) {
        final String USAGE = "\n" +
                "others.CreateBucket - create an S3 bucket\n\n" +
                "Usage: others.CreateBucket <bucketname>\n\n" +
                "Where:\n" +
